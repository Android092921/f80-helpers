    ...
    if msgs > max_msg then
      ...
      if gbanspamonredis then
        if tonumber(gbanspamonredis) ==  4 and not is_owner(msg) then
          ...
          send_large_msg("chat#id"..msg.to.id, "> کاربر :\n [ "..name.." ]{"..msg.from.id.."} از همه گروه ها و سوپر گروه ها بن شد!دلیل(#اسپم)")
		  send_large_msg("channel#id"..msg.to.id, "> کاربر :\n [ "..name.." ]"..msg.from.id.."از همه گروه ها و سوپر گروه ها بن شد !دلیل(#اسپم)")
          local GBan_log = 'GBan_log'
		  local GBan_log =  data[tostring(GBan_log)]
		  for k,v in pairs(GBan_log) do
			log_SuperGroup = v
			gban_text = "> کاربر :\n [ "..name.." ]( @"..username.." ){"..msg.from.id.."} از همه گروه ها و سوپر گروه های من بن شد ! ( "..msg.to.print_name.." ) [ "..msg.to.id.." ] دلیل(#اسپم)"
